...
function pfValidSignature( $pfData, $pfParamString, $pfPassphrase = 'Diamonds.888' ) {
...
function pfValidServerConfirmation( $pfParamString, $pfHost = 'payfast.co.za', $pfProxy = null ) {
